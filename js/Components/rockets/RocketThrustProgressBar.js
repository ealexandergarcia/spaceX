import { RocketEngineTotal, RocketEngineVacuumTotal } from "../../helper/filtros.js";
...
export const informRocketEngineThrustVacuum = async(thrust_vacuum)=>{
    const [{engines}] = await getAllRockets(RocketEngineVacuumTotal);
    let data =engines.thrust_sea_level;
    let {kN:totalKN} = data;
    ...
    divFirst.append(divFirstChildren)
    div.append(divFirst)
    let section__information__1 = document.querySelector(".section__information__3");
    let firstDiv = section__information__1.querySelector("div:first-child");
    section__information__1.replaceChild(div, firstDiv);
}